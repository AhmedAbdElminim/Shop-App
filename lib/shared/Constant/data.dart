...
class Data {
 ...
 /* static List<ProductModel> LaptopList = [];
  static List<ProductModel> PhonesList = [];
  static List<ProductModel> BeautyList = [];
  static List<ProductModel> FurnitureList = [];
  static List<ProductModel> ClothesList = [];
  static List<ProductModel> ShoesList = [];
  static List<ProductModel> WathchesList = [];

  static List<ProductModel> getCategoryList({index}) {
  ...
  static List<ProductModel> AdidasList = [];
  static List<ProductModel> AppleList = [];
  static List<ProductModel> DellList = [];
  static List<ProductModel> HuaweiList = [];
  static List<ProductModel> NikeList = [];
  static List<ProductModel> SamsungList = [];
  static List<ProductModel> HMList = [];
  static List<ProductModel>AllPopularBrandList=[];
  static List<ProductModel>getAllPopularBrandList({index}){
    AllPopularBrandList=[];
    for (int i = 0; i < products.length; i++){
  ...
  static List<ProductModel> getBrandList({index}) {
    AdidasList = [];
    AppleList = [];
    DellList = [];
    HuaweiList = [];
  ...
  static List<ProductModel>PopularProductList=[];
  static List<ProductModel>getPopularProduct({index}){
    PopularProductList=[];
    for(int i=0;i<products.length;i++){
